...
use App\Http\Resources\Attendance\CustomAttendanceResource;
...
class AttendanceController extends BaseApiController
{
    ...
    public function index(Request $request): \Illuminate\Http\JsonResponse
    {
        ...
        $data = CustomAttendanceResource::collection($attendance);
    ...
    public function store(CreateAttendanceRequest $request): \Illuminate\Http\JsonResponse
    {
        ...
        try {
            ...
            $totalHours = $this->countHours($data);
    ...
    public function countHours($data): int
    {
        $startTime = $data['start_time'];
        $endTime = $data['end_time'];
        $startDate = $data['start_date'];
        $endDate = $data['end_date'];
        $totalHours = DateHelper::countAttendanceHours($startDate, $endDate, $startTime, $endTime);
        return $totalHours;
    }
