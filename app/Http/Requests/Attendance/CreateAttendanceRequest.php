...
class CreateAttendanceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'end_time' => ['required', 'date_format:H:i:s', new UniqueAttendance($this->input('start_date'), $this->input('end_date'), $this->input('start_time'), $this->input('end_time'), $this->input('type_id'))],
